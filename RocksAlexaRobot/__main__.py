...
from RocksAlexaRobot.modules.sudoers import bot_sys_stats
        ...
        InlineKeyboardButton(
                   ...
                   [
                    ...
                    [                  
                       InlineKeyboardButton(
                             text="💠 ᴋɪɴɢ",
                             url=f"https://t.me/Dr_Asad_Ali"),
                       InlineKeyboardButton(
                             text="💠 ғᴇᴅ",
                             url=f"https://t.me/rocksopfed"),
                        ],
                       [
...
@run_async
def alexa_about_callback(update, context):
    query = update.callback_query
    if query.data == "alexa_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Rocks Alexa*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\nIf you have any question about Rocks Alexa, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..😍 I'm *Rocks Alexa*
                 \nHere is the [Source Code](https://github.com/jankarikiduniya) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "I'm Online Now! My Updates @AsadSupport")
        except Unauthorized:
            LOGGER.warning(
                "Bot isnt able to send message to @AsadSupport, go and check!"
            )
    ...
    about_callback_handler = CallbackQueryHandler(alexa_about_callback, pattern=r"alexa_")
