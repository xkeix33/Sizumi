...
from RocksAlexaRobot import (
    ...
    URL,
    WEBHOOK,
    SUPPORT_CHAT,UPDATES_CHANNEL,BOT_USERNAME,
    dispatcher,
    StartTime,
    telethn,
    updater)
...
PM_START_TEXT = """
 ───『[Rocks Alexa The Robot](https://telegra.ph/file/fc9f211c92d62561d9109.jpg)』───
Hello! User,👋
I am *Rocks Alexa*
...
All commands can be used with the following: [ᴄᴏᴍᴍᴀɴᴅs](https://telegra.ph/file/78821dcca7be5a6362bc5.jpg)
...
DONATE_STRING = """Contact to **@AsadSupport**"""
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@AsadSupport","[Back Online (:](https://telegra.ph/file/d3db0babad0d1729c5f59.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
