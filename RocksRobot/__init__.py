# Rocks Official Management Property Of Rocks Indian Largest Chatting Group
...
print("[RocksRobot]: Initializing AIOHTTP Session")
aiohttpsession = ClientSession() 

updater = tg.Updater(TOKEN, workers=WORKERS, use_context=True)
telethn = TelegramClient("KURUMIBOT", API_ID, API_HASH)
pgram = Client("RocksRobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from RocksRobot.modules.helper_funcs.handlers import (CustomCommandHandler,
